...
export abstract class UserInteraction {
    constructor(public connection: Connection, public interaction: Interaction, public emojis: any) {}
...
export abstract class CommandUserInteraction extends UserInteraction {
    constructor(public connection: Connection, public interaction: CommandInteraction, public emojis: any) {
        super(connection, interaction, emojis);
    }
}

export abstract class ButtonUserInteraction extends UserInteraction {
    constructor(public connection: Connection, public interaction: ButtonInteraction, public emojis: any, public customData = interaction.customId.split("||")[1].split(":").slice(1)) {
        super(connection, interaction, emojis);
    }
}

export abstract class MenuUserInteraction extends UserInteraction {
    constructor(public connection: Connection, public interaction: SelectMenuInteraction, public emojis: any, public customData = interaction.customId.split("||")[1].split(":").slice(1)) {
        super(connection, interaction, emojis);
    }
}